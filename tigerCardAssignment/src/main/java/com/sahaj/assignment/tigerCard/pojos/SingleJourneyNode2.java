...
public class SingleJourneyNode2 implements IJourneyNode{
	...
	public SingleJourneyNode2(SingleJourneyNodeBuilder singleJourneyNodeBuilder)
	{
	...
	public static class SingleJourneyNodeBuilder 
	{
		...
		public SingleJourneyNode2 build()
		{
			return new SingleJourneyNode2(this);
		}
